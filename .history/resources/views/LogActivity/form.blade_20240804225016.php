                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->tanggal }}</td>
                                            <td>
                                                <a href="/m2mbwa/edit/{{ $item->id_log }}" class="btn btn-warning fa fa-pencil-square-o" title="Edit">Edit</a>
                                                <a href="/m2mbwa/delete/{{ $item->id_log }}" class="btn btn-danger remove-user fa fa-trash" title="Delete">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
