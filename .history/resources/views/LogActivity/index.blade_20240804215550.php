...
<script>
    ...
    function updateTable(data) {
        ...
        data.forEach(item => {
            ...
            idCell.textContent = item.id_log;
            const nameCell = document.createElement('td');
            nameCell.textContent = item.nama;
            const inisialCell = document.createElement('td');
            valueCell.textContent = item.inisial;
            const valueCell = document.createElement('td');
            valueCell.textContent = item.activity;
            const dateCell = document.createElement('td');
            valueCell.textContent = item.tanggal;
