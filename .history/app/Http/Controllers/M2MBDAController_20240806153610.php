...
class M2MBDAController extends Controller
{
    ...
    {
        $datas = DB::table('m2m_bda')
                ->orderBy('updated_at', 'asc')
                ->get();

        return view('m2mbda.index', compact('datas'));
    ...
    public function simpan(Request $request)
    {
        ...
        return redirect('/m2mbda')->with('pesan', 'Data Tersimpan');
    }

    public function edit ($id)
    {
        //dd($id);
        $data = DB::table('m2m_bda')
                ->where('id_soltemp', $id)
                ->get();
        //dd($data);
        return view('m2mbda.edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/m2mbda')->with('pesan', 'Data Berhasil Diubah');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('/m2mbda')->with('pesan', 'Data Deleted');
    }
