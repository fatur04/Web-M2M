...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function(){
    ...
    Route::get('/m2msast', [M2MBDAController::class, 'show']);
    Route::get('/m2msast/update-status/{nojar}', [M2MBDAController::class, 'status']);
    Route::post('/m2msast/simpan', [M2MBDAController::class, 'simpan']);
    Route::get('/m2msast/edit/{id}', [M2MBDAController::class, 'edit']);
    Route::post('/m2msast/update/{id}', [M2MBDAController::class, 'update']);
    Route::delete('/m2msast/delete/{id}', [M2MBDAController::class, 'delete']);
