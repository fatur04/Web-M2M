...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
    <form action="/m2msast/simpan" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <tbody>
            @foreach($datas as $index => $data)
                <tr>
                    ...
                    <td>
                        <a href="/m2msast/edit/{{ $data->id_soltemp }}" class="btn btn-warning fa fa-pencil-square-o" title="Edit"></a>
                        <a href="/m2msast/delete/{{ $data->id_soltemp }}" class="btn btn-danger remove-user fa fa-trash" title="Delete"></a>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var pesan = `*_This is BoT Whatsapp SEOA-SAST_*%0D%0A%0D%0A
